...
def atualizar_cotacoes():
    try:
        ...
        label_atualizarcotacoes["text"] = "Selcione o arquivo correto"

janela = tk.Tk()

janela.title("Cotação de Moedas")

label_cotacaomoeda = tk.Label(text="Cotação de 1 Moeda Especifica", borderwidth=2, relief='solid', font='Montserrat')
...
label_cotacaovariasmoedas = tk.Label(text="Cotação de Varias Moedas", borderwidth=2, relief='solid', font='Montserrat')
...
var_caminho_arquivo = tk.StringVar(value="")
...
label_atualizarcotacoes = tk.Label(text="", anchor="e")
